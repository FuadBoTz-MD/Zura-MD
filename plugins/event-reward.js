...
let handler = async(m, { conn }) => {
    ...
    if (user.reward === 0) {
        await conn.sendButtonLoc(m.chat, await(await fetch(thumb2)).buffer(), `Terimakasih sudah menggunakan Haruno Bot, hingga sekarang Haruno Bot sudah berjalan selama 6 bulan lebih.\nBerikut hadiah mu:
