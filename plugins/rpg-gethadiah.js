...
const sections = [
   {
    ...
    title: `✃ INFO`,
	rows: [
	    {title: "💻INFO BOT", rowId: '.info', description: 'Info Sullivan BOT' },
	    {title: "🗃️MENU", rowId: '.menu', description: 'Back to menu' },
	{title: "👤OWNER", rowId: '.owner', description: 'Owner Sullivan BOT' },
	{title: "💰SEWA BOT", rowId: '.sewa', description: 'Sewa Sullivan BOT' },
	]
    },
]
