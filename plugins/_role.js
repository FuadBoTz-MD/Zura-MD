...
handler.before = function (m) {
  let user = global.db.data.users[m.sender]
        let role = (user.level <= 2) ? 'Newbie ㋡'
          ...
          : ((user.level >= 460) && (user.level <= 470)) ? 'Brigadier Gold ✰'
          : ((user.level >= 470) && (user.level <= 480)) ? 'Brigadier Platinum ✩'
          : ((user.level >= 480) && (user.level <= 490)) ? 'Brigadier Diamond ✯' 
          : ((user.level >= 490) && (user.level <= 500)) ? 'Brigadier General ✮'
          : ((user.level >= 500) && (user.level <= 600)) ? 'LT General ✪'
          : ((user.level >= 600) && (user.level <= 700)) ? 'LT General ✪✪'
          : ((user.level >= 700) && (user.level <= 800)) ? 'LT General ✪✪✪'
          : ((user.level >= 800) && (user.level <= 900)) ? 'LT General ✪✪✪✪'
          : ((user.level >= 900) && (user.level <= 1000)) ? 'General ✪✪✪✪✪'
          : ((user.level >= 1000) && (user.level <= 1100)) ? 'Legendary 숒'
          : ((user.level >= 1100) && (user.level <= 1200)) ? 'Legendary 숒숒'
          : ((user.level >= 1200) && (user.level <= 1300)) ? 'Legendary 숒숒숒'
          : ((user.level >= 1300) && (user.level <= 1500)) ? 'Master 숒 × Legendary 숒'
          : ((user.level >= 1500) && (user.level <= 1600)) ? 'Mythic ✮'
          : ((user.level >= 1600) && (user.level <= 1700)) ? 'Mythical ✮✮'
          : ((user.level >= 1700) && (user.level <= 2000)) ? 'Mythical Gloryy ✮✮✮'
          : ((user.level >= 2000) && (user.level <= 2100)) ? 'Orichalcum 숒'
          : ((user.level >= 2100) && (user.level <= 2200)) ? 'Orichalcum 숒숒'
          : ((user.level >= 2200) && (user.level <= 2500)) ? 'Orichalcum 숒숒숒'
          : ((user.level >= 2500) && (user.level <= 3000)) ? 'Adamantite 敗'
          : ((user.level >= 3000) && (user.level <= 5000)) ? 'Master Adamantie 숒'
          : ((user.level >= 5000) && (user.level <= 9999)) ? 'Adamantitan's 客'
          : ((user.level >= 10000) && (user.level <= 14999)) ? 'Master Adamantitan's 客'
          : 'Legend of Adamantite 숒'
  user.role = role
  return true
}
