...
let kataanimesad = pickRandom(global.kataanine)
	let url = 'https://api.zahwazein.xyz/randomimage/aesthetic?apikey=85345ee3d9de'
	let cap = `🐦Kataanimesad: ${kataanimesad}\n     ${wm}`
	conn.sendButton(m.chat, `${command}`, cap, await(await fetch(url)).buffer(), [['Menu', '.menuv2',],['Next',`.${command}`,]],m)
}
